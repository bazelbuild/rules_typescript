...
export function parseTsconfig(
  ...
  if (config.extends) {
    ...
    if (userConfig.bazelOptions) {
      ...
      bazelOpts.googmodule = bazelOpts.googmodule || userConfig.bazelOptions.googmodule;
    }
  ...
  // If the user requested goog.module, we need to produce that output even if the
  // generated tsconfig indicates otherwise.
