...
readonly LIBRARY_JS=$(cat $(rlocation "build_bazel_rules_typescript_examples/some_library/library.js"))
readonly BAR_JS=$(cat $(rlocation "build_bazel_rules_typescript_examples/bar.js"))
readonly FOO_JS=$(cat $(rlocation "build_bazel_rules_typescript_examples/foo.js"))
...
# should produce named UMD modules
if [[ "$BAR_JS" != *"define(\"build_bazel_rules_typescript_examples/bar\""* ]]; then
...
if [[ "$BAR_JS" != *"require(\"build_bazel_rules_typescript_examples/foo\")"* ]]; then
...
if [[ "$BAR_JS" != *"require(\"build_bazel_rules_typescript_examples/generated_ts\")"* ]]; then
...
# should produce named UMD modules
if [[ "$FOO_JS" != *"define(\"build_bazel_rules_typescript_examples/foo\""* ]]; then
